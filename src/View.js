...
export default function View() {
    ...
    const handleDelete2 = (id) => {
        if (id) {
            ...
            localStorage.setItem('data', JSON.stringify(Taskdelete))
    ...
    const handleEdit = (id) => {
        ...
        for (let i = 0; i < Data.length; i++) {
            if (Data[i].id == id) {
                ...
                formik.setFieldValue('NameEdit', Data[i].Name)
                formik.setFieldValue('email', Data[i].email)
    ...
    const formik = useFormik({
        ...
        onSubmit: (values) => {
            if (TaskEditID) {
                ...
                let updateData = Data
                updateData[findEditRow].Name = values.NameEdit
                updateData[findEditRow].email = values.email
                            ...
                            <Modal.Body>
                                <form onSubmit={formik.handleSubmit}>
                                    <div className='text-start mb-4'>
                                        ...
                                        />
                                        {formik.errors.NameEdit && formik.touched.NameEdit && (
                                            <p>{formik.errors.NameEdit}</p>
                                        )}
                                    </div>
                                    <div className='text-start mb-4'>
